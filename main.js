...
$(() => {
    ...
    let toggledCoin = [];
    let chartCoins = [];
    $("#homeSection").html(`<img class="loader" src="/assets/images/Loader.png" alt="">`);
    let chartInterval;
    ...
    $("#homeSection").on("click", ".coin-card > button", async function () {
        ...
        const loader = `<div><img id="loader_${coin.id}" class="load" src="/assets/images/Loader.png" alt="load"></div>`;
    ...
    $("#homeSection").on("click", "i", async function () {
        ...
        function showModal(titleHtml, contentHtml, buttons) {
            ...
            $(".modal").on("click", "i", function () {
                ...
                // console.log("chosen", thisCoin);
                if (star === true) {
                    $(this).removeClass("fa-solid fa-star toggle");
                    $(this).addClass("fa-regular fa-star toggle").css("color", "rgba(255, 255, 255, 0.7)");
                    deleteCoin(thisCoin);
                    deleteChartCoin(chartCoin);
                    // console.log("Deleted", thisCoin);
                    // console.log("Added", c);
                }
                // console.log(toggledCoin);
                $(".modal").remove();
    ...
    $("#homeSection").on("keyup", "input[type=search]", function () {
        ...
        if (textToSearch === "") {
            ...
            if (filteredCoins.length > 0) {
                ...
                $("#shownCoins").html("No results were found, please try again").css("margin-top", "10px");
            }
        }
    });
    ...
    function displayCoins(coins) {
        const header = `<div><h1 id="mainHeader">Rocket Crypto</h1></div>`;
        const search = `<div>
    ...
    function createCard(coin) {
        const card = `
        <div class="coin-card glass-effect">
        <div class=${coin.id}>
        ...
        <button id="${coin.id}" class="moreInfoBtn">More Info</button>
        <div></div>
        </div>`;
        return card;
    }
    ...
    <h2>About my self</h2> 
    <div id="allInfo"> 
    <div> <img src="/assets/images/Me.JPG" alt="Me" id="personalImg"> </div>
    <div id="personalInfo"  class="glass-effect">
    <p>Dennis Rabinovitch | 29 | Tel-Aviv</p>
    <p>Married | Ecaterina | Makeup Artist</p>
    <p>Military service | 2012 | Discipline Nco | Air force, AA Units </p>
    <p>John Bryce Student | Full-Stack Developer </p>
    <div id="personalSkills"> <p>Skills: HTML | CSS | JavaScript | TypeScript | jQuery </p> </div>
    </div> 
    </div>
    <div id="followMeLinks">
    <ul class="followMe">
    <li> <a href="https://www.facebook.com/dennis.rabinovitch/" target="_blank"><i class="fa-brands fa-square-facebook fbIcon"></i></a> </li>
    <li> <a href="https://instagram.com/dennis_rabinovitch?igshid=YmMyMTA2M2Y=" target="_blank"><i class="fa-brands fa-instagram igIcon"></i></a> </li>
    <li> <a href="https://il.linkedin.com/in/dennis-rabinovitch-685039228" target="_blank"><i class="fa-brands fa-linkedin liIcon"></i></a> </li>
    </ul>
    </div>
    </div>`;
    ...
    $("a[data-section='liveReportSection']").on("click", function () {
        ...
        if (chartCoins.length === 0) {
            $("#chartContainer").html("Please select at least one coin for Live Reports.");
            return;
        }
